    ...
    <div style={{ display: 'flex', justifyContent: 'space-between', padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
      ...
      <div style={{ display: 'flex', gap: '20px' }}>
        ...
        <div style={{ width: '300px', border: '1px solid #ddd', borderRadius: '8px', overflow: 'hidden' }}>
          <Image src="/images/iphone15pro-pink.png" alt="iPhone 15 Pro Pink" width={300} height={350} />
      ...
      <div style={{ width: '400px', border: '1px solid #ddd', borderRadius: '8px', padding: '20px', textAlign: 'center' }}>
        <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '10px' }}>
            <Image src="/images/mobile-icon.png" alt="Mobile Icon" width={30} height={30} />
        </div>
        <h2 style={{ marginBottom: '20px' }}>MOBILE</h2>
        <div style={{ display: 'flex', justifyContent: 'space-around', marginBottom: '20px' }}>
            <Image src="/images/apple-logo.png" alt="Apple Logo" width={50} height={50} />
            <Image src="/images/samsung-logo.png" alt="Samsung Logo" width={50} height={50} />
